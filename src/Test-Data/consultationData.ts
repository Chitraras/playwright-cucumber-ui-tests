export const consultationData = {
    ...
    getResourcesCTAButton: 'button:has-text("Get Free Resources")',

    // Popup controls
    closeResourcesButton: 'button:has(svg path[d="M6 18L18 6M6 6l12 12"])',
    enterNameInput: '//input[@placeholder="Enter your name"]',
    enterEmailInput: '//input[@placeholder="Enter your email"]',
        submitResourcesButton: 'role=button[name="Download Resources"]',
    Name : 'Tester',
